let gulp,config,fs,imagemin;_acb‍.w("gulp",[["default",["gulp"],function(v){gulp=v}]]);_acb‍.w("../",[["default",["config"],function(v){config=v}]]);_acb‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_acb‍.w("gulp-imagemin",[["default",["imagemin"],function(v){imagemin=v}]]);
